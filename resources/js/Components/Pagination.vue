<template>
    <nav class="mt-3 flex items-center justify-between rounded-md bg-white shadow px-4 py-3 sm:px-6"
        ...
        <div class="flex flex-1 justify-between sm:justify-end">
            <Link :href="previous" preserve-state
